...
class Board {
    constructor() {
        loader.load('../assets/board.glb', (glb) => {
            console.log(glb);
            scene.add(glb.scene);
            glb.scene.scale.set(0.1, 0.1, 0.1);
            glb.scene.position.set(0,-1, 60);
            // glb.scene.rotation.set(0,130,0);
            this.boat = glb.scene;
        })
    }
...
class Boat {
    constructor() {
        loader.load('../assets/dog.glb', (glb) => {
            console.log(glb);
            scene.add(glb.scene);
            glb.scene.scale.set(0.03, 0.03, 0.03);
            glb.scene.position.set(5,0, 90);
            glb.scene.rotation.set(0,4.75,0);
            this.boat = glb.scene;
        })
    }
